ten_things = "Coke Fallakka Acid DMT Meth Cocain Weed"  #defined a string 
print("there are not ten things in the list. lest add some") 
stuff = ten_things.split(' ') #splitting the strings
more_stuff = ['Money', 'Power','Politics','Control','Religion','War','Slavery','Tobacco'] # declaring a list
